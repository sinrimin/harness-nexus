  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <ChevronDownIcon data-slot="select-chevron" className="size-4 opacity-50" />
...
export { Select, SelectValue, SelectTrigger, SelectContent, SelectGroup, SelectItem, SelectLabel };
